 ...
 */
package de.hybris.platform.a2core.service.impl;
...
public class DefaultA2coreService implements A2coreService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultA2coreService.class);
	...
	{
		return DefaultA2coreService.class.getResourceAsStream("/a2core/sap-hybris-platform.png");
	}
