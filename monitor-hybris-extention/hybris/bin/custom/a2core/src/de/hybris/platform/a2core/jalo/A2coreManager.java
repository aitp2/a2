...
/**
 * This is the extension manager of the A2core extension.
 */
public class A2coreManager extends GeneratedA2coreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(A2coreManager.class);
	 ...
	 */
	public static A2coreManager getInstance()
	{
		return (A2coreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(A2coreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public A2coreManager() // NOPMD 
	{
		LOG.debug("constructor of A2coreManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of A2coreManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of A2coreManager called, current tenant: {}", getTenant().getTenantID());
	}
