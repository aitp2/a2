...
/**
 * This is the extension manager of the A2facade extension.
 */
public class A2facadeManager extends GeneratedA2facadeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(A2facadeManager.class);
	 ...
	 */
	public static A2facadeManager getInstance()
	{
		return (A2facadeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(A2facadeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public A2facadeManager() // NOPMD 
	{
		LOG.debug("constructor of A2facadeManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of A2facadeManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of A2facadeManager called, current tenant: {}", getTenant().getTenantID());
	}
