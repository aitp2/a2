 ...
 */
package com.a2.a2facade.service.impl;
...
public class DefaultA2facadeService implements A2facadeService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultA2facadeService.class);
	...
	{
		return DefaultA2facadeService.class.getResourceAsStream("/a2facade/sap-hybris-platform.png");
	}
