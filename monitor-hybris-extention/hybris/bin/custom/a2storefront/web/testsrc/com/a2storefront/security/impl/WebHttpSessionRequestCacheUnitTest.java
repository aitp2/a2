...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/a2storefront/electronics/en",
						"https://electronics.local:9002/a2storefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/a2storefront/electronics/en",
						"https://electronics.local:9002/a2storefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/a2storefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/a2storefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/a2storefront/electronics/en",
						"https://electronics.local:9002/a2storefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/a2storefront",
						"https://electronics.local:9002/a2storefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/a2storefront",
						"https://electronics.local:9002/a2storefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/a2storefront/electronics/en",
						"https://electronics.local:9002/a2storefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
