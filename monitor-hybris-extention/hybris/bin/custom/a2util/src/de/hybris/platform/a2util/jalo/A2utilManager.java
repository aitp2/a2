 ...
 */
package de.hybris.platform.a2util.jalo;
...
/**
 * This is the extension manager of the A2util extension.
 */
public class A2utilManager extends GeneratedA2utilManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(A2utilManager.class);
	 ...
	 */
	public static A2utilManager getInstance()
	{
		return (A2utilManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(A2utilConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public A2utilManager() // NOPMD 
	{
		LOG.debug("constructor of A2utilManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of A2utilManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of A2utilManager called, current tenant: {}", getTenant().getTenantID());
	}
