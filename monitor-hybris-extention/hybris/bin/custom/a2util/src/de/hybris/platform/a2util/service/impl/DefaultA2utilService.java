...
public class DefaultA2utilService implements A2utilService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultA2utilService.class);
	...
	{
		return DefaultA2utilService.class.getResourceAsStream("/a2util/sap-hybris-platform.png");
	}
